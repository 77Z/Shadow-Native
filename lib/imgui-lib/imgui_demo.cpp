...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("UI demo", p_open, window_flags))
    {
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("[BETA] [VT] Power saving mode reduces the framerate when idle");
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Plotting"))
    {
        ...
        if (animate) ImGui::SetMaxWaitBeforeNextFrame(1.0 / 30.0);
