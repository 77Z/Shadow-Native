...
float ImGui_VT_getScrollSmoothing() {
	return scroll_smoothing;
}

ImVec2 ImGui_VT_getScrollEnergy() {
	return scroll_energy;
}


static ImVec2 scrollData = ImVec2(0.0f, 0.0f);
ImVec2 ImGui_VT_getLatestScrollData() {
    return scrollData;
}
...
void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
    ...
    scrollData.x = xoffset;
    scrollData.y = yoffset;
