...
inline void SetupTheme() {
	...
	colors[ImGuiCol_ChildBg]                = ImVec4(1.00f, 1.00f, 1.00f, 0.02f);
	colors[ImGuiCol_PopupBg]                = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
	colors[ImGuiCol_Border]                 = ImVec4(0.20f, 0.20f, 0.20f, 0.24f);
	...
	colors[ImGuiCol_Button]                 = ImVec4(1.00f, 1.00f, 1.00f, 0.09f);
	colors[ImGuiCol_ButtonHovered]          = ImVec4(1.00f, 1.00f, 1.00f, 0.14f);
	colors[ImGuiCol_ButtonActive]           = ImVec4(1.00f, 1.00f, 1.00f, 0.17f);
	colors[ImGuiCol_Header]                 = ImVec4(1.00f, 0.17f, 0.17f, 1.00f);
	colors[ImGuiCol_HeaderHovered]          = ImVec4(1.00f, 1.00f, 1.00f, 0.14f);
	colors[ImGuiCol_HeaderActive]           = ImVec4(1.00f, 0.17f, 0.17f, 1.00f);
	colors[ImGuiCol_Separator]              = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
	colors[ImGuiCol_SeparatorHovered]       = ImVec4(1.00f, 0.17f, 0.17f, 0.40f);
	colors[ImGuiCol_SeparatorActive]        = ImVec4(1.00f, 0.17f, 0.17f, 1.00f);
	colors[ImGuiCol_ResizeGrip]             = ImVec4(1.00f, 1.00f, 1.00f, 0.19f);
	colors[ImGuiCol_ResizeGripHovered]      = ImVec4(1.00f, 1.00f, 1.00f, 0.35f);
	colors[ImGuiCol_ResizeGripActive]       = ImVec4(1.00f, 1.00f, 1.00f, 0.43f);
	colors[ImGuiCol_TabHovered]             = ImVec4(0.18f, 0.18f, 0.18f, 1.00f);
	colors[ImGuiCol_Tab]                    = ImVec4(0.09f, 0.09f, 0.09f, 1.00f);
	colors[ImGuiCol_TabSelected]            = ImVec4(0.13f, 0.13f, 0.13f, 1.00f);
	...
	colors[ImGuiCol_TabDimmedSelected]      = ImVec4(0.14f, 0.14f, 0.14f, 0.97f);
	...
	colors[ImGuiCol_TextSelectedBg]         = ImVec4(1.00f, 0.17f, 0.17f, 0.39f);
