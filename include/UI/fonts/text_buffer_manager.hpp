#ifndef SHADOW_NATIVE_UI_FONTS_TEXT_BUFFER_MANAGER_HPP
#define SHADOW_NATIVE_UI_FONTS_TEXT_BUFFER_MANAGER_HPP
...
#endif // SHADOW_NATIVE_UI_FONTS_TEXT_BUFFER_MANAGER_HPP
